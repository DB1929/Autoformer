...
import numpy as np
import wandb
wandb.init(project="Autoformer_try", entity="fyq9719", config={})
...
# parser.add_argument('--model_id', type=str, required=True, default='ECL_96_96', help='model id')
...
# forecasting task 这里 label_len 就是 seq_len/2，也就是I/2,用于构建decoder输入
